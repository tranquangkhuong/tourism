...
abstract class RepositoryEloquent implements RepositoryInterface
{
    ...
    */
    ...
    public function getImageDirectory($addPath = '')
    {
        ...
        if (!is_dir(public_path($this->_model->imagePath . $addPath))) {
            mkdir(public_path($this->_model->imagePath . $addPath), 0777, true);
        }
        return public_path($this->_model->imagePath . $addPath);
    }
