...
{
    protected $bookingDetailTable = 'booking_details';
    ...
    public function getBooking($userId)
    {
        ...
        DB::table('booking_details')->select('tours.name', 'booking_details.other_day', 'booking_details.total_slot', 'booking_details.total_price', 'booking_details.created_at')->join('tours', 'booking_details.tour_id', '=', 'tours.id')->orderByDesc('created_at');
    }
