...
class TourRepositoryEloquent extends RepositoryEloquent implements TourRepositoryInterface
{
    ...
    {
        return Attribute::select('id')->where('name', 'include')->first()->id;
    }
    ...
    {
        return Attribute::select('id')->where('name', 'not_include')->first()->id;
    }
    ...
    {
        return $this->_model->values()->where('attribute_id', $this->getIncludeId())->get();
    }
