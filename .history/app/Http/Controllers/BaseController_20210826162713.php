...
class BaseController extends Controller
{
    ...
    public function detailTour($tourId)
    {
        ...
        // Binh luan & danh gia
        $comments = Comment::select('comments.content', 'users.name', 'users.avatar_image_path', 'users.profile_image_path')->join('users', 'comments.user_id', '=', 'users.id')->where('comments.tour_id', $tourId)
    }
}
