...
Route::group(['as' => 'user.', 'middleware' => 'user'], function () {
    Route::get('/profile', [UserController::class, 'profile'])->middleware('auth:user')->name('profile');
    Route::post('/profile/update', [UserController::class, 'update'])->middleware('auth:user')->name('update');
...
Route::get('ttt', function () {
    $html = "<form action='/ttt' method='POST' enctype='multipart/form-data'>";
    $html .= "@csrf";
    $html .= "<input type='file' name='image' id="">";
