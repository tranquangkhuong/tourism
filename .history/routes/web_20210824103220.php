...
Route::group(['prefix' => '/admin', 'as' => 'admin.', 'middleware' => 'auth:user'], function () {
    ...
    // Route::group(['prefix' => '/tour-plan', 'as' => 'tour_plan.'], function () {
    //     Route::get('/', [TourController::class, 'index'])->name('index');
    //     Route::get('/index-data', [TourController::class, 'indexData'])->name('index_data');
    //     Route::get('/add', [TourController::class, 'create'])->name('add');
    //     Route::post('/store', [TourController::class, 'store'])->name('store');
    //     Route::get('/edit/{tour_plan_id}', [TourController::class, 'edit'])->name('edit');
    //     Route::post('/update/{tour_plan_id}', [TourController::class, 'update'])->name('update');
    //     Route::get('/delete/{tour_plan_id}', [TourController::class, 'destroy'])->name('delete');
    // });
    ...
    Route::group(['prefix' => '/article', 'as' => 'article.'], function () {
        ...
        Route::get('/edit/{article_id}', [SliderController::class, 'edit'])->name('edit');
        Route::post('/update/{article_id}', [SliderController::class, 'update'])->name('update');
        Route::get('/delete/{article_id}', [SliderController::class, 'destroy'])->name('delete');
    });
});
