...
Route::group(['prefix' => '/admin', 'as' => 'admin.', 'middleware' => 'auth:user'], function () {
    ...
    Route::group(['prefix' => '/tour', 'as' => 'tour.'], function () {
        ...
        Route::group(['prefix' => '/plan', 'as' => 'plan.'], function () {
            ...
            Route::post('/update/{tour_id}', [TourPlanController::class, 'update'])->name('update');
            Route::get('/delete/{tour_id}', [TourPlanController::class, 'destroy'])->name('delete');
        });

        Route::group(['prefix' => '/image', 'as' => 'image.'], function () {
            Route::get('/', [TourImageController::class, 'index'])->name('index');
            Route::get('/index-data', [TourImageController::class, 'indexData'])->name('index_data');
