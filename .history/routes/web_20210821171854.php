...
Route::get('ttt', function () {
    dd(Tour::select('values.id', 'values.attribute_id', 'values.tour_id', 'values.value')->where('id', 6)->join('values', 'tours.id', '=', 'values.tour_id')->where('values.attribute_id', 2)->get());
});
