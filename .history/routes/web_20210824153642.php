...
Route::group(['prefix' => '/admin', 'as' => 'admin.', 'middleware' => 'auth:user'], function () {
    ...
    Route::group(['prefix' => '/tour', 'as' => 'tour.'], function () {
        ...
        Route::group(['prefix' => '/plan', 'as' => 'plan.'], function () {
            // Route::get('/', [TourPlanController::class, 'index'])->name('index');
            // Route::get('/index-data', [TourPlanController::class, 'indexData'])->name('index_data');
            Route::get('/add', [TourPlanController::class, 'create'])->name('add');
            Route::post('/store', [TourPlanController::class, 'store'])->name('store');
            Route::get('/edit/{tour_plan_id}', [TourPlanController::class, 'edit'])->name('edit');
            Route::post('/update/{tour_plan_id}', [TourPlanController::class, 'update'])->name('update');
            Route::get('/delete/{tour_plan_id}', [TourPlanController::class, 'destroy'])->name('delete');
        });
    });
