...
<body>
    <form action="{{ route('admin.tour.plan.store') }}" method="post">
        ...
        <div class="container1">
            ...
            <div>
                <input type="number" name="day1" placeholder="day">
                <textarea name="content1" id="summernote" placeholder="content"></textarea>
            </div>
            <input type="text" name="note1" id="" placeholder="note">
        </div>
