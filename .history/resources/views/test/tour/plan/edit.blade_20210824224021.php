...
<body>
    ...
    <div class="container1">
        ...
        <button type="button" id="button-update" data-id="{{ $item->id }}" onclick="confirmUpdate()">update</button>
        <button type="button" id="button-delete" data-id="{{ $item->id }}">delete</button>
        @endforeach
