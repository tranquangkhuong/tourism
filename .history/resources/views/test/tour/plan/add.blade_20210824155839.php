...
<script>
    ...
    $(add_button).click(function(e) {
        ...
        if (x < max_fields) {
            x++;
            $(wrapper).append(`<div>
        <input type="number" name="day${x-1}" placeholder="day">
        <textarea name="content${x-1}" id="summernote" placeholder="content"></textarea>
        <input type="text" name="note${x-1}" id="" placeholder="note">
        <a href="#" class="delete">Delete</a>
    </div>`); //add input box
        } else {
