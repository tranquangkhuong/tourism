...
<script type="text/javascript">
    ...
    $.each(response, (index, value) => {
        ...
        <td>
            <ul class="list-inline">
                <li class="list-inline-item">
                    <img src="{{ URL::asset('${value.image_path}') }}" alt="image slider" style="width:50%">
                </li>
            </ul>
        </td>
        ...
        <td class="project-actions text-right">
            ...
            <a class="btn btn-danger btn-sm" href="javascript::void(0)" onclick="confirmDelete('slider', ${value.id})">
