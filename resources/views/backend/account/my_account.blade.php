        ...
        <div class="card card-primary">
            ...
            <form action="{{ url('/admin/account/update') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="card-body">
                        <div class="row">
                            <div class="col-md-3"  >
                                <div class="form-group text-center"style="margin-bottom:50px ;width:300px;margin-left: 50%;transform: translateX(-50%);>
                                    <label for="exampleInputFile">Ảnh đại diện</label>
                                        <div class="input-group">
                                        <label class="show-img_add edit-img_admin" for="exampleInputFile" style="border: initial;">
                                            <div class="text-center" width="100%">
                                                <div class="img-tour_add disabled img-admin" style="width:250px;height:250px;border-radius:50%">
                                                    <div class="img-tour_add-show">
                                                            <img  src="" alt="" id="image" class="img-admin" width="100%" height="100%" style="width:250px;height:250px;border-radius:50%;border: 2px solid blue;transform: translateX(-50%); ">
                                                    </div>
                                                    <span class="img-tour_link" style="display:none"> </span>
                                                </div>
                                                <div class="img-tour_file ">
                                                    <img src="{{ $account->avatar_image_path }}" class="fas fa-plus icon-add_tour " id="show_edit-img" alt="tour img" style="width:250px;height:250px;border-radius:50%;border: 2px solid blue;">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="name" id="name" class="form-control text-center" placeholder="Username" style="border: inherit;
    font-size: 2rem;"
                                    value="{{ $account->name }}">
                                 </div>
                            </div>
                ...
                <div class="card-footer">
                    <a href="{{ url('/admin/dashboard') }}" class="btn btn-sm btn-secondary">Thoát</a>
