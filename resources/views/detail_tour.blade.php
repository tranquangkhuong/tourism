        ...
        <section class="header-bottom">
            ...
            <div class="header-right">
                ...
                <div class="slider">
                    ...
                    <img src="{{ URL::asset('frontend/img/img_slider/person.png') }} " class="person translate"
                        data-speed="-0.25" alt="">
                    <img src="{{ URL::asset('frontend/img/img_slider/slider1.jpg') }} " class="slider-img translate"
                        data-speed="0.4" alt="">
                </div>
                <div class="body_main">
                    <div class="standard-container grid wide">
                        <div class="container-search-content-holder ">
                            <div class="search-ordering-list row " style="">
                                <button class="tablinks btn-buttom_list active col l-2-4 m-6 c-12"><i
                                        class="fas fa-book"></i>thông
                                    tin chi tiết</button>
                                <button class="tablinks btn-buttom_list col l-2-4 m-6 c-12"> <i
                                        class="far fa-calendar-alt"></i>kế
                                    hoạch tour</button>
                                <button class="tablinks btn-buttom_list col l-2-4 m-6 c-12"><i
                                        class="fas fa-map-marker-alt"></i>địa
                                    chỉ </button>
                                <button class="tablinks btn-buttom_list col l-2-4 m-6 c-12"><i
                                        class="fas fa-camera-retro"></i>bộ
                                    sưu tập</button>
                                <button class="tablinks btn-buttom_list col l-2-4 m-6 c-12"><i
                                        class="far fa-comments"></i>đánh
                                    giá</button>
                            </div>
                        </div>
                            ...
                            <div class="container_list-product col l-9 m-12 c-12">
                                ...
                                <div class="tabcontent active">
                                    <div class="product-detail-information">
                                        ...
                                        <div class="product-detail-information">
                                            ...
                                            <div class="product-detail-content">
                                                <p>Hầ giang là nơi một trong số khu vực đẹp mhất tây bắc với phong cảnh
                                                    giản dị mộc
                                                    mạc và là nơi có nhiều núi non hùng vĩ với phông cảnh tuyệt vời.</p>
                                            </div>
                                            <div class="list-img_detail row">
                                                ...
                                                <div class="grallery col l-4 c-12 m-6 ">
                                                    <span>
                                                        <img class="item-img myImg"
                                                            src="{{ URL::asset('frontend/img/detail-product/pc2.jpg') }}"
                                                            alt="ngôi nhà đá hà giang">
                                                    </span>
                                                </div>
                                                <div class="grallery col l-4 c-12 m-6 ">
                                                    <span>
                                                        <img class="item-img myImg"
                                                            src="{{ URL::asset('frontend/img/detail-product/pc3.jpg') }}"
                                                            alt="ruộng bậc thang ">
                                                    </span>
                                                </div>
                                            </div>
                                ...
                                <div class="tabcontent">
                                    ...
                                    <div class="list-tour_pain">
                                        ...
                                        <div class="text-tour_psin">
                                            <p class="text-container_pain">
                                                Tối thứ 5 bắt xe giường nằm lên thành phố Hà Giang, thuê xe tại thành
                                                phố Hà Giang
                                                hoặc gửi xe máy theo từ Hà Nội nếu bạn không thể thuê xe.
                                            </p>
                                            <p class="text-container_pain">
                                    ...
                                    <div class="list-tour_pain">
                                        ...
                                        <p class="titel-date_tour_pain">ngày 2: Hà Giang – Quản Bạ – Yên Minh – Phó Bảng
                                            – Sủng Là –
                                            Đồng Văn</p>
                                        <div class="text-tour_psin">
                                            <p class="text-container_pain">
                                    ...
                                    <div class="list-tour_pain">
                                        ...
                                        <p class="titel-date_tour_pain">ngày 3: Đồng Văn – Lũng Cú – Dinh Vương – Đồng
                                            Văn – Mã Pì
                                            Lèng – Mèo Vạc</p>
                                        <div class="text-tour_psin">
                                            <p class="text-container_pain">
                                    ...
                                    <div class="list-tour_pain">
                                        ...
                                        <p class="titel-date_tour_pain">ngày 4: Mèo Vạc – Mậu Duệ – Du Già (tùy thời
                                            tiết) – Yên
                                            Minh – Hà Giang</p>
                                        <div class="text-tour_psin">
                                            <p class="text-container_pain">
                                    ...
                                    <div class="list-tour_pain">
                                        ...
                                        <p class="titel-date_tour_pain">ngày 5: Ba Bể – Phủ Thông – Bắc Kạn – Hà Nội
                                            (220km)</p>
                                        <div class="text-tour_psin">
                                            <p class="text-container_pain">
                                                Tối thứ 5 bắt xe giường nằm lên thành phố Hà Giang, thuê xe tại thành
                                ...
                                <div class="tabcontent">
                                    <div class="location-taital_pain">
                                        <div class="detail-tour_pain">
                                            ...
                                            <p>Đồng Văn – Lũng Cú (26km) – Dinh Vương (26km) – Đồng Văn (15km) lên với
                                                điểm cực Bắc
                                                của Việt Nam,rồi rời Lũng Cú về Dinh Vua Mèo Vương Chí Sình. Trưa về
                                                nghỉ và ăn trưa
                                                tại Đồng Văn</p>
                                        </div>
                                    ...
                                    <div class="img-detail">
                                        ...
                                        <figure class="action-img">
                                            <img src="https://assets.codepen.io/12005/snowy.jpg"
                                                alt="a river in the snow" class="img-detail_list_tour" />
                                        </figure>
                                        <figure class="landscape action-img">
                                ...
                                <div class="tabcontent">
                                    <div class="reviews-tour">
                                        <div class="detail-tour_pain">
                                            ...
                                            <p>Không chỉ được thiên nhiên ưu ái cho nhiều danh lam thắng cảnh được thế
                                                giới trầm
                                                trồ, Hà Giang còn là nơi lưu giữ những di tích lịch sử lâu đời cũng như
                                                nét đẹp văn
                                                hóa đặc sắc của 22 dân tộc vùng cao phía Bắc. Tất cả đã tạo nên sức hút
                                                hấp dẫn
                                                khiến các tín đồ du lịch không ngừng tìm kiếm kinh nghiệm du lịch Hà
                                                Giang để chinh
                                                phục trọn vẹn vùng sơn cước xinh đẹp này</p>
                                        </div>
                            ...
                            <div class="container-search_product col l-3 m-12 c-12">
                                <div class="container-feedback ">
                                    <div class="feedback_list-items book-card">
                                        <div class="feedback-items">
                                            <h2 class="contact_us-title " style="text-transform:capitalize">đặt chuyến
                                                thăm quan tại
                                                đây</h2>
                                        </div>
                                        <div class=" feedback_content-information">
                                            <div class="feedback_information-email-card ">
                                                ...
                                                <input class="feedback_input-card add-card" type="text"
                                                    placeholder="Name*">
                                            </div>
                                            <div class="feedback_information-email-card">
                                            ...
                                            <div class="feedback_information-email-card">
                                                ...
                                                <input class="feedback_input-card add-card" type="tel"
                                                    placeholder="Phone*">
                                            </div>
                                            <div class="feedback_information-email-card">
                                            ...
                                            <div class="feedback-content content-card">
                                                <span></span>
                                                <textarea name="" class="feedback_content-text content_text-card"
                                                    cols="5" rows="6" placeholder="Message"></textarea>
                                            </div>
                            ...
                            <div class="row footer-wrap">
                                <div class="col l-3 m-6 c-12 footer-column">
                                    <div class="footer-logo ">
                                        <a href="#"><img src="{{ URL::asset('frontend/img/logo_toursm.png') }}"
                                                alt="logo"></a>
                                    </div>
                                    <p class="text-description">Lorem ipsum dolor sit ametco nsec te tuer adipiscing
                                        elitae</p>
                                ...
                                <div class="col l-3 m-6 c-12 footer-column">
                                    ...
                                    <div class="footer__location">
                                        <a href="#" class="recent-location text-p-medium">Visit Thailand, Bali And
                                            China</a>
                                ...
                                <div class="col l-3 m-6 c-12 footer-column">
                                    ...
                                    <p class="text-p-medium">Etiam rhoncus. Maecenas temp us, tellus eget condimentum
                                        rho</p>
                ...
                <script src="{{ URL::asset('frontend/js/main.js') }}"></script>
                <script src="{{ URL::asset('frontend/js/detail_tour/detail_tour.js') }}"></script>
                >>>>>>> f926710a116c00f05f8fb81dccf8b7a4615b5923
</body>
