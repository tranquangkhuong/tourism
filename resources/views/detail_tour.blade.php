        ...
        <div class="standard-container grid wide">
            <div class="container-search-content-holder ">
                <div class="search-ordering-list row " style="">
                    <button class="tablinks btn-buttom_list active col l-2-4 m-6 c-12"><i class="fas fa-book"></i>thông
                        tin chi tiết</button>
                    <button class="tablinks btn-buttom_list col l-2-4 m-6 c-12"> <i class="far fa-calendar-alt"></i>kế
                        hoạch tour</button>
                    <button class="tablinks btn-buttom_list col l-2-4 m-6 c-12"><i class="fas fa-map-marker-alt"></i>địa
                        chỉ </button>
                    <button class="tablinks btn-buttom_list col l-2-4 m-6 c-12"><i class="fas fa-camera-retro"></i>bộ
                        sưu tập</button>
                ...
                <div class="container_list-product col l-9 m-12 c-12">
                    ...
                    <div class="tabcontent active">
                        <div class="product-detail-information">
                            ...
                            <div class="product-detail-information">
                                ...
                                <div class="product-detail-content">
                                    <p>Hầ giang là nơi một trong số khu vực đẹp mhất tây bắc với phong cảnh giản dị mộc
                    ...
                    <div class="tabcontent">
                        ...
                        <div class="list-tour_pain">
                            ...
                            <div class="text-tour_psin">
                                <p class="text-container_pain">
                                    Tối thứ 5 bắt xe giường nằm lên thành phố Hà Giang, thuê xe tại thành phố Hà Giang
                        ...
                        <div class="list-tour_pain">
                            ...
                            <p class="titel-date_tour_pain">ngày 3: Đồng Văn – Lũng Cú – Dinh Vương – Đồng Văn – Mã Pì
                                Lèng – Mèo Vạc</p>
                            <div class="text-tour_psin">
                                <p class="text-container_pain">
                                    Tối thứ 5 bắt xe giường nằm lên thành phố Hà Giang, thuê xe tại thành phố Hà Giang
                        ...
                        <div class="list-tour_pain">
                            ...
                            <p class="titel-date_tour_pain">ngày 4: Mèo Vạc – Mậu Duệ – Du Già (tùy thời tiết) – Yên
                                Minh – Hà Giang</p>
                            <div class="text-tour_psin">
                                <p class="text-container_pain">
                                    Tối thứ 5 bắt xe giường nằm lên thành phố Hà Giang, thuê xe tại thành phố Hà Giang
                    ...
                    <div class="tabcontent">
                        <div class="location-taital_pain">
                            <div class="detail-tour_pain">
                                ...
                                <p>Đồng Văn – Lũng Cú (26km) – Dinh Vương (26km) – Đồng Văn (15km) lên với điểm cực Bắc
                                    của Việt Nam,rồi rời Lũng Cú về Dinh Vua Mèo Vương Chí Sình. Trưa về nghỉ và ăn trưa
                                    tại Đồng Văn</p>
                            </div>
                        ...
                        <div class="reviews-tour">
                            <div class="detail-tour_pain">
                                ...
                                <p>Không chỉ được thiên nhiên ưu ái cho nhiều danh lam thắng cảnh được thế giới trầm
                                    trồ, Hà Giang còn là nơi lưu giữ những di tích lịch sử lâu đời cũng như nét đẹp văn
                                    hóa đặc sắc của 22 dân tộc vùng cao phía Bắc. Tất cả đã tạo nên sức hút hấp dẫn
                                    khiến các tín đồ du lịch không ngừng tìm kiếm kinh nghiệm du lịch Hà Giang để chinh
