            ...
            <div class="standard-container grid wide">
                <div class="container-search-content-holder ">
                    <div class="search-ordering-list  translate  row .wide " style="" data-speed="-0.25">
                        ...
                        <h1 class="title-detail_blog">Amazing Tour </h1>
                    </div>
                </div>
                <div class="container-product translate row" data-speed="-0.25" style="background-color:#fff ; ">
                    <div class="container_list-product detail-blog col l-9 m-12 c-12">
                        ...
                        <img src="https://setsail.qodeinteractive.com/wp-content/uploads/2016/09/blog-img-12.jpg"
                            alt="">
                        <p> Si elit omnes impedit ius, vel et hinc agam fabulas. Ut audiam invenire iracundia vim. Tn
                            eam dimo diam ea. Piber Korem sit amet. Cconsequat tin sit, stet cibo blandit.Al elit omnes
                            impedit ius, vel et hinc agam fabulas. Ut audiam invenire iracundia vim. En eam dico
                            similique, ut sint posse sit, eum sumo diam ea. Liber consectetuer in mei, sea in imperdiet
                            assueverit contentiones, an his cibo blandit tacimates. Iusto iudicabit similique id velex,
                            in sea rebum deseruisse appellantur. Lorem ipsum Alienum phaedrum torquatos nec eu, vis
                            detraxit pericu in mei, vix aperiri vix at,dolor sit amet. blandit dicant definition.Sit
                            delicata persequeris ex, in sea rebum deseruisse appellantur. Lorem ipsum dolor sit amet.Eos
                            ei nisl graecis, vix aperiri consequat an. Eius lorem.</p>
                    ...
                    <div class="container-search_product col l-3 m-12 c-12">
                        <div class="container-feedback ">
                            <div class="feedback_list-items book-card">
                                ...
                                <img src="https://lh5.googleusercontent.com/dqwUAw6JRBaU9g7YHFXIGILnuv28HzD66wLEcyCYpet87nia-zUi7oTzjQiLnzoIDag_LA5ptsB6P8VMtMAxlRfRvoMIqkgsn0zoHoE3U4nMbnBtKTxuX0R2vtX5_4epwJwK2XSE=s1600"
                                    alt="" class="about-me_img">
                                <p class="text-about_me">Lorem ipsum dolor sit amet, consect etuiscing elit. In ut
                                    ullamcorper leo</p>
                            </div>
                        </div>
                            ...
                            <div class="blogmasonry-title_item blog l-12 c-12 m-12">
                                ...
                                <div class="blogmasonry_item-title__row">
                                    ...
                                    <div class="blogmasonry_content-detail">
                                        <a href="" class="blogmasonry_detail-link">xem thêm <i
        ...
        <div class="modal-container">
            ...
            <div class="form-body form-body-login active">
                ...
                <form id="login-form" action="http://localhost:8000/login" method="POST">
                    <input type="hidden" name="_token" value="8ekYObQZgK3qm56q8v1HZXvPsy48hPknuvzM4Qqe"> <input
            ...
            <div class="form-body form-body-register ">
                ...
                <form id="register-form" action="http://localhost:8000/register" method="POST">
                    <input type="hidden" name="_token" value="8ekYObQZgK3qm56q8v1HZXvPsy48hPknuvzM4Qqe"> <input
                        type="text" id="name" name="name" placeholder="User name" required>
