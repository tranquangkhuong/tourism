...
<link type="text/css" href="{{ URL::asset('frontend/css/fonts/font.css') }}" rel="stylesheet">
<link type="text/css" href="{{ URL::asset('frontend/css/fonts/Satisfy.css') }}" rel="stylesheet">
<!-- favicon -->
