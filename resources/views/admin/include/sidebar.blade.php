<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="../../index3.html" class="brand-link">
      <img src="{{ URL::asset('frontend/img/adminlogo.PNG') }}" alt="Admin vietTour" class="brand-image img-circle elevation-3" style="opacity: .8">
      <span class="brand-text font-weight-light">admin vieTour</span>
    </a>
